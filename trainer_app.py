...
def _parse_args(argv=None):
    ...
    parser.add_argument("--port", type=int, default=8787, help="Flask 监听端口")
    parser.add_argument("--debug", action="store_true", default=True, help="开启 Flask debug（默认开）")
    parser.add_argument("--no-debug", dest="debug", action="store_false", help="关闭 Flask debug")
